...
export const caseStudies: Record<string, CaseStudy> = {
  ...
  hmsu: {
    statusLine: "LIVE · 5개년 국가 R&D 과제 3년차 — 1인 PM · 개발",
    title: "한약안전사용 플랫폼",
    overview:
      "보건복지부·과기정통부 한의디지털융합기술개발사업의 5개년 과제 ‘빅데이터에 기반한 한약 안전 사용 플랫폼’으로 구축한 공식 웹서비스. 한국한의약진흥원·국가생약정보 등 기관마다 흩어져 있던 한약 데이터 3만건+를 수집·정제해 통합 검색으로 묶고, 사용자 관리 시스템까지 1인 PM·개발로 완주했습니다.",
    meta: [
    ...
    sections: [
      ...
      },
      {
        ...
        prose: [
          ...
          { em: "PM과 개발을 혼자 수행" },
          "한 프로젝트입니다. 데이터를 제공받기 위한 외부 기관 협의와 공문 대응도 개발과 병행해 직접 처리했습니다. 웹 개발자로 근무하며 첫 실무 과제로 완주했습니다.",
        ],
      },
      {
        heading: "## 핵심 작업",
